 ...
 */
/* Compiler settings for CoDSPECISO.idl:
...
typedef struct _CoDSPECISO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } CoDSPECISO_MIDL_TYPE_FORMAT_STRING;

typedef struct _CoDSPECISO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } CoDSPECISO_MIDL_PROC_FORMAT_STRING;

typedef struct _CoDSPECISO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } CoDSPECISO_MIDL_EXPR_FORMAT_STRING;
...
extern const CoDSPECISO_MIDL_TYPE_FORMAT_STRING CoDSPECISO__MIDL_TypeFormatString;
extern const CoDSPECISO_MIDL_PROC_FORMAT_STRING CoDSPECISO__MIDL_ProcFormatString;
extern const CoDSPECISO_MIDL_EXPR_FORMAT_STRING CoDSPECISO__MIDL_ExprFormatString;
...
static const CoDSPECISO_MIDL_PROC_FORMAT_STRING CoDSPECISO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const CoDSPECISO_MIDL_TYPE_FORMAT_STRING CoDSPECISO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IISO_ProxyInfo =
    {
    &Object_StubDesc,
    CoDSPECISO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    CoDSPECISO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _CoDSPECISO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IISOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _CoDSPECISO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IISOStubVtbl,
    0
};

PCInterfaceName const _CoDSPECISO_InterfaceNamesList[] = 
{
    "IISO",
    0
};

const IID *  const _CoDSPECISO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoDSPECISO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoDSPECISO, pIID, n)

int __stdcall _CoDSPECISO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoDSPECISO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoDSPECISO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoDSPECISO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoDSPECISO_StubVtblList,
    (const PCInterfaceName * ) & _CoDSPECISO_InterfaceNamesList,
    (const IID ** ) & _CoDSPECISO_BaseIIDList,
    & _CoDSPECISO_IID_Lookup, 
    1,
    2,
