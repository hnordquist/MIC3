 ...
 */
/* Compiler settings for CoEthernetCSO.idl:
...
typedef struct _CoEthernetCSO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } CoEthernetCSO_MIDL_TYPE_FORMAT_STRING;

typedef struct _CoEthernetCSO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } CoEthernetCSO_MIDL_PROC_FORMAT_STRING;

typedef struct _CoEthernetCSO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } CoEthernetCSO_MIDL_EXPR_FORMAT_STRING;
...
extern const CoEthernetCSO_MIDL_TYPE_FORMAT_STRING CoEthernetCSO__MIDL_TypeFormatString;
extern const CoEthernetCSO_MIDL_PROC_FORMAT_STRING CoEthernetCSO__MIDL_ProcFormatString;
extern const CoEthernetCSO_MIDL_EXPR_FORMAT_STRING CoEthernetCSO__MIDL_ExprFormatString;
...
static const CoEthernetCSO_MIDL_PROC_FORMAT_STRING CoEthernetCSO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const CoEthernetCSO_MIDL_TYPE_FORMAT_STRING CoEthernetCSO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO ICSO_ProxyInfo =
    {
    &Object_StubDesc,
    CoEthernetCSO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    CoEthernetCSO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _CoEthernetCSO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICSOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _CoEthernetCSO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICSOStubVtbl,
    0
};

PCInterfaceName const _CoEthernetCSO_InterfaceNamesList[] = 
{
    "ICSO",
    0
};

const IID *  const _CoEthernetCSO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoEthernetCSO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoEthernetCSO, pIID, n)

int __stdcall _CoEthernetCSO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoEthernetCSO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoEthernetCSO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoEthernetCSO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoEthernetCSO_StubVtblList,
    (const PCInterfaceName * ) & _CoEthernetCSO_InterfaceNamesList,
    (const IID ** ) & _CoEthernetCSO_BaseIIDList,
    & _CoEthernetCSO_IID_Lookup, 
    1,
    2,
