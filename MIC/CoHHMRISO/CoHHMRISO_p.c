...
/* at Thu Mar 07 15:15:44 2019
 */
/* Compiler settings for CoHHMRISO.idl:
...
typedef struct _CoHHMRISO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } CoHHMRISO_MIDL_TYPE_FORMAT_STRING;

typedef struct _CoHHMRISO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } CoHHMRISO_MIDL_PROC_FORMAT_STRING;

typedef struct _CoHHMRISO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } CoHHMRISO_MIDL_EXPR_FORMAT_STRING;
...
extern const CoHHMRISO_MIDL_TYPE_FORMAT_STRING CoHHMRISO__MIDL_TypeFormatString;
extern const CoHHMRISO_MIDL_PROC_FORMAT_STRING CoHHMRISO__MIDL_ProcFormatString;
extern const CoHHMRISO_MIDL_EXPR_FORMAT_STRING CoHHMRISO__MIDL_ExprFormatString;
...
static const CoHHMRISO_MIDL_PROC_FORMAT_STRING CoHHMRISO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const CoHHMRISO_MIDL_TYPE_FORMAT_STRING CoHHMRISO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IISO_ProxyInfo =
    {
    &Object_StubDesc,
    CoHHMRISO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    CoHHMRISO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _CoHHMRISO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IISOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _CoHHMRISO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IISOStubVtbl,
    0
};

PCInterfaceName const _CoHHMRISO_InterfaceNamesList[] = 
{
    "IISO",
    0
};

const IID *  const _CoHHMRISO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoHHMRISO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoHHMRISO, pIID, n)

int __stdcall _CoHHMRISO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoHHMRISO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoHHMRISO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoHHMRISO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoHHMRISO_StubVtblList,
    (const PCInterfaceName * ) & _CoHHMRISO_InterfaceNamesList,
    (const IID ** ) & _CoHHMRISO_BaseIIDList,
    & _CoHHMRISO_IID_Lookup, 
    1,
    2,
