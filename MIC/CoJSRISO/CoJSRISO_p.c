...
typedef struct _CoJSRISO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } CoJSRISO_MIDL_TYPE_FORMAT_STRING;

typedef struct _CoJSRISO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } CoJSRISO_MIDL_PROC_FORMAT_STRING;

typedef struct _CoJSRISO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } CoJSRISO_MIDL_EXPR_FORMAT_STRING;
...
extern const CoJSRISO_MIDL_TYPE_FORMAT_STRING CoJSRISO__MIDL_TypeFormatString;
extern const CoJSRISO_MIDL_PROC_FORMAT_STRING CoJSRISO__MIDL_ProcFormatString;
extern const CoJSRISO_MIDL_EXPR_FORMAT_STRING CoJSRISO__MIDL_ExprFormatString;
...
static const CoJSRISO_MIDL_PROC_FORMAT_STRING CoJSRISO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const CoJSRISO_MIDL_TYPE_FORMAT_STRING CoJSRISO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IISO_ProxyInfo =
    {
    &Object_StubDesc,
    CoJSRISO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    CoJSRISO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _CoJSRISO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IISOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _CoJSRISO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IISOStubVtbl,
    0
};

PCInterfaceName const _CoJSRISO_InterfaceNamesList[] = 
{
    "IISO",
    0
};

const IID *  const _CoJSRISO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoJSRISO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoJSRISO, pIID, n)

int __stdcall _CoJSRISO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoJSRISO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoJSRISO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoJSRISO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoJSRISO_StubVtblList,
    (const PCInterfaceName * ) & _CoJSRISO_InterfaceNamesList,
    (const IID ** ) & _CoJSRISO_BaseIIDList,
    & _CoJSRISO_IID_Lookup, 
    1,
    2,
