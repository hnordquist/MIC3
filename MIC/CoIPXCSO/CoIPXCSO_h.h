...
#ifndef __CoIPXCSO_h_h__
#define __CoIPXCSO_h_h__
...
#ifndef __IPXCSO_FWD_DEFINED__
#define __IPXCSO_FWD_DEFINED__

#ifdef __cplusplus
typedef class IPXCSO IPXCSO;
#else
typedef struct IPXCSO IPXCSO;
#endif /* __cplusplus */

#endif 	/* __IPXCSO_FWD_DEFINED__ */
...
#ifndef __COIPXCSOLib_LIBRARY_DEFINED__
#define __COIPXCSOLib_LIBRARY_DEFINED__

/* library COIPXCSOLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_COIPXCSOLib;

EXTERN_C const CLSID CLSID_IPXCSO;

#ifdef __cplusplus

class DECLSPEC_UUID("C2186BC1-FADA-440A-A7E8-8B1CEF2E8B5E")
IPXCSO;
#endif
#endif /* __COIPXCSOLib_LIBRARY_DEFINED__ */
