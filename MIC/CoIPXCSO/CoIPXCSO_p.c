...
typedef struct _CoIPXCSO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } CoIPXCSO_MIDL_TYPE_FORMAT_STRING;

typedef struct _CoIPXCSO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } CoIPXCSO_MIDL_PROC_FORMAT_STRING;

typedef struct _CoIPXCSO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } CoIPXCSO_MIDL_EXPR_FORMAT_STRING;
...
extern const CoIPXCSO_MIDL_TYPE_FORMAT_STRING CoIPXCSO__MIDL_TypeFormatString;
extern const CoIPXCSO_MIDL_PROC_FORMAT_STRING CoIPXCSO__MIDL_ProcFormatString;
extern const CoIPXCSO_MIDL_EXPR_FORMAT_STRING CoIPXCSO__MIDL_ExprFormatString;
...
static const CoIPXCSO_MIDL_PROC_FORMAT_STRING CoIPXCSO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const CoIPXCSO_MIDL_TYPE_FORMAT_STRING CoIPXCSO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO ICSO_ProxyInfo =
    {
    &Object_StubDesc,
    CoIPXCSO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    CoIPXCSO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _CoIPXCSO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICSOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _CoIPXCSO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICSOStubVtbl,
    0
};

PCInterfaceName const _CoIPXCSO_InterfaceNamesList[] = 
{
    "ICSO",
    0
};

const IID *  const _CoIPXCSO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoIPXCSO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoIPXCSO, pIID, n)

int __stdcall _CoIPXCSO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoIPXCSO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoIPXCSO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoIPXCSO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoIPXCSO_StubVtblList,
    (const PCInterfaceName * ) & _CoIPXCSO_InterfaceNamesList,
    (const IID ** ) & _CoIPXCSO_BaseIIDList,
    & _CoIPXCSO_IID_Lookup, 
    1,
    2,
