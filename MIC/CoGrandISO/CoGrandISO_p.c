...
/* at Thu Mar 07 15:14:47 2019
 */
/* Compiler settings for CoGrandISO.idl:
...
typedef struct _CoGrandISO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } CoGrandISO_MIDL_TYPE_FORMAT_STRING;

typedef struct _CoGrandISO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } CoGrandISO_MIDL_PROC_FORMAT_STRING;

typedef struct _CoGrandISO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } CoGrandISO_MIDL_EXPR_FORMAT_STRING;
...
extern const CoGrandISO_MIDL_TYPE_FORMAT_STRING CoGrandISO__MIDL_TypeFormatString;
extern const CoGrandISO_MIDL_PROC_FORMAT_STRING CoGrandISO__MIDL_ProcFormatString;
extern const CoGrandISO_MIDL_EXPR_FORMAT_STRING CoGrandISO__MIDL_ExprFormatString;
...
static const CoGrandISO_MIDL_PROC_FORMAT_STRING CoGrandISO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const CoGrandISO_MIDL_TYPE_FORMAT_STRING CoGrandISO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IISO_ProxyInfo =
    {
    &Object_StubDesc,
    CoGrandISO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    CoGrandISO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _CoGrandISO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IISOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _CoGrandISO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IISOStubVtbl,
    0
};

PCInterfaceName const _CoGrandISO_InterfaceNamesList[] = 
{
    "IISO",
    0
};

const IID *  const _CoGrandISO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoGrandISO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoGrandISO, pIID, n)

int __stdcall _CoGrandISO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoGrandISO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoGrandISO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoGrandISO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoGrandISO_StubVtblList,
    (const PCInterfaceName * ) & _CoGrandISO_InterfaceNamesList,
    (const IID ** ) & _CoGrandISO_BaseIIDList,
    & _CoGrandISO_IID_Lookup, 
    1,
    2,
