...
typedef struct _CoISRISO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } CoISRISO_MIDL_TYPE_FORMAT_STRING;

typedef struct _CoISRISO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } CoISRISO_MIDL_PROC_FORMAT_STRING;

typedef struct _CoISRISO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } CoISRISO_MIDL_EXPR_FORMAT_STRING;
...
extern const CoISRISO_MIDL_TYPE_FORMAT_STRING CoISRISO__MIDL_TypeFormatString;
extern const CoISRISO_MIDL_PROC_FORMAT_STRING CoISRISO__MIDL_ProcFormatString;
extern const CoISRISO_MIDL_EXPR_FORMAT_STRING CoISRISO__MIDL_ExprFormatString;
...
static const CoISRISO_MIDL_PROC_FORMAT_STRING CoISRISO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const CoISRISO_MIDL_TYPE_FORMAT_STRING CoISRISO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IISO_ProxyInfo =
    {
    &Object_StubDesc,
    CoISRISO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    CoISRISO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _CoISRISO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IISOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _CoISRISO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IISOStubVtbl,
    0
};

PCInterfaceName const _CoISRISO_InterfaceNamesList[] = 
{
    "IISO",
    0
};

const IID *  const _CoISRISO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CoISRISO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CoISRISO, pIID, n)

int __stdcall _CoISRISO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CoISRISO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CoISRISO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CoISRISO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CoISRISO_StubVtblList,
    (const PCInterfaceName * ) & _CoISRISO_InterfaceNamesList,
    (const IID ** ) & _CoISRISO_BaseIIDList,
    & _CoISRISO_IID_Lookup, 
    1,
    2,
