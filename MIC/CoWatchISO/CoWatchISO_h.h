...
#ifndef __CoWatchISO_h_h__
#define __CoWatchISO_h_h__
...
#ifndef __WatchISO_FWD_DEFINED__
#define __WatchISO_FWD_DEFINED__

#ifdef __cplusplus
typedef class WatchISO WatchISO;
#else
typedef struct WatchISO WatchISO;
#endif /* __cplusplus */

#endif 	/* __WatchISO_FWD_DEFINED__ */
...
#ifndef __COWATCHISOLib_LIBRARY_DEFINED__
#define __COWATCHISOLib_LIBRARY_DEFINED__

/* library COWATCHISOLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_COWATCHISOLib;

EXTERN_C const CLSID CLSID_WatchISO;

#ifdef __cplusplus

class DECLSPEC_UUID("FA40B144-C1F8-4e4b-A729-F4261195C4C7")
WatchISO;
#endif
#endif /* __COWATCHISOLib_LIBRARY_DEFINED__ */
