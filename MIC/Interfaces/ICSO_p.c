 ...
 */
/* Compiler settings for ICSO.idl:
...
typedef struct _ICSO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ICSO_MIDL_TYPE_FORMAT_STRING;

typedef struct _ICSO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ICSO_MIDL_PROC_FORMAT_STRING;

typedef struct _ICSO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ICSO_MIDL_EXPR_FORMAT_STRING;
...
extern const ICSO_MIDL_TYPE_FORMAT_STRING ICSO__MIDL_TypeFormatString;
extern const ICSO_MIDL_PROC_FORMAT_STRING ICSO__MIDL_ProcFormatString;
extern const ICSO_MIDL_EXPR_FORMAT_STRING ICSO__MIDL_ExprFormatString;
...
static const ICSO_MIDL_PROC_FORMAT_STRING ICSO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ICSO_MIDL_TYPE_FORMAT_STRING ICSO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO ICSO_ProxyInfo =
    {
    &Object_StubDesc,
    ICSO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    ICSO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _ICSO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICSOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _ICSO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICSOStubVtbl,
    0
};
...
const IID *  const _ICSO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
