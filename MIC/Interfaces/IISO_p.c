 ...
 */
/* Compiler settings for IISO.idl:
...
typedef struct _IISO_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } IISO_MIDL_TYPE_FORMAT_STRING;

typedef struct _IISO_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } IISO_MIDL_PROC_FORMAT_STRING;

typedef struct _IISO_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } IISO_MIDL_EXPR_FORMAT_STRING;
...
extern const IISO_MIDL_TYPE_FORMAT_STRING IISO__MIDL_TypeFormatString;
extern const IISO_MIDL_PROC_FORMAT_STRING IISO__MIDL_ProcFormatString;
extern const IISO_MIDL_EXPR_FORMAT_STRING IISO__MIDL_ExprFormatString;
...
static const IISO_MIDL_PROC_FORMAT_STRING IISO__MIDL_ProcFormatString =
    {
        0,
        {
...
static const IISO_MIDL_TYPE_FORMAT_STRING IISO__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IISO_ProxyInfo =
    {
    &Object_StubDesc,
    IISO__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    IISO__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _IISO_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IISOProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _IISO_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IISOStubVtbl,
    0
};

PCInterfaceName const _IISO_InterfaceNamesList[] = 
{
    "IISO",
    0
};

const IID *  const _IISO_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _IISO_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _IISO, pIID, n)

int __stdcall _IISO_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_IISO_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo IISO_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _IISO_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _IISO_StubVtblList,
    (const PCInterfaceName * ) & _IISO_InterfaceNamesList,
    (const IID ** ) & _IISO_BaseIIDList,
    & _IISO_IID_Lookup, 
    1,
    2,
