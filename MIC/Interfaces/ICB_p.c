...
typedef struct _ICB_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ICB_MIDL_TYPE_FORMAT_STRING;

typedef struct _ICB_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ICB_MIDL_PROC_FORMAT_STRING;

typedef struct _ICB_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ICB_MIDL_EXPR_FORMAT_STRING;
...
extern const ICB_MIDL_TYPE_FORMAT_STRING ICB__MIDL_TypeFormatString;
extern const ICB_MIDL_PROC_FORMAT_STRING ICB__MIDL_ProcFormatString;
extern const ICB_MIDL_EXPR_FORMAT_STRING ICB__MIDL_ExprFormatString;
...
static const ICB_MIDL_PROC_FORMAT_STRING ICB__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ICB_MIDL_TYPE_FORMAT_STRING ICB__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO ICB_ProxyInfo =
    {
    &Object_StubDesc,
    ICB__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    ICB__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _ICB_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICBProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _ICB_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICBStubVtbl,
    0
};

PCInterfaceName const _ICB_InterfaceNamesList[] = 
{
    "ICB",
    0
};

const IID *  const _ICB_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _ICB_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _ICB, pIID, n)

int __stdcall _ICB_IID_Lookup( const IID * pIID, int * pIndex )
{
...
const ExtendedProxyFileInfo ICB_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _ICB_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _ICB_StubVtblList,
    (const PCInterfaceName * ) & _ICB_InterfaceNamesList,
    (const IID ** ) & _ICB_BaseIIDList,
    & _ICB_IID_Lookup, 
    1,
    2,
